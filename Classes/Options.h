...
class Options
{
    ...
    public:
        ...
        static const char* ACHIEVEMENTS_UNLOCK_JUNIOR;
        static const char* ACHIEVEMENTS_UNLOCK_AVIARIST;
        static const char* ACHIEVEMENTS_UNLOCK_KILLER;
        static const char* ACHIEVEMENTS_UNLOCK_LORD_OF_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_TRIPPLE_KILL;
        static const char* ACHIEVEMENTS_UNLOCK_ULTRA_KILL;
        static const char* ACHIEVEMENTS_UNLOCK_RAMPAGE;
        static const char* ACHIEVEMENTS_UNLOCK_FAN_OF_GREEN_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_FAN_OF_YELLOW_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_FAN_OF_AZURE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_FAN_OF_PURPLE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_FAN_OF_RED_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_FAN_OF_ORANGE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_FAN_OF_BLUE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_KILLER_OF_GREEN_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_KILLER_OF_YELLOW_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_KILLER_OF_AZURE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_KILLER_OF_PURPLE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_KILLER_OF_RED_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_KILLER_OF_ORANGE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_KILLER_OF_BLUE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_HUNTER_OF_GREEN_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_HUNTER_OF_YELLOW_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_HUNTER_OF_AZURE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_HUNTER_OF_PURPLE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_HUNTER_OF_RED_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_HUNTER_OF_ORANGE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_HUNTER_OF_BLUE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_LORD_OF_GREEN_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_LORD_OF_YELLOW_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_LORD_OF_AZURE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_LORD_OF_PURPLE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_LORD_OF_RED_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_LORD_OF_ORANGE_BIRDS;
        static const char* ACHIEVEMENTS_UNLOCK_LORD_OF_BLUE_BIRDS;
