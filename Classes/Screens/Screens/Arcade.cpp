...
Arcade::Arcade() :
    Game()
    {
        ...
        this->mTimeText = new Text((Textes) {"0:59", Options::FONT, 80, -1}, this);
        ...
        this->mTimeIcon->create()->setCenterPosition(Utils::coord(64), Options::CAMERA_HEIGHT - Utils::coord(232));
        ...
        this->mTimeText->setCenterPosition(Utils::coord(120) + this->mTimeText->getWidth() / 2, Options::CAMERA_HEIGHT - Utils::coord(232));
