...
Progress::Progress()
{
    ...
    Text* text1 = new Text(Options::TEXT_PROGRESS_STRING_1, this);
    Text* text2 = new Text(Options::TEXT_PROGRESS_STRING_2, this);
    Text* text3 = new Text(Options::TEXT_PROGRESS_STRING_3, this);
    
    text1->setPosition(ccp(Options::CAMERA_CENTER_X, Options::CAMERA_CENTER_Y + Utils::coord(300)));
    text2->setPosition(ccp(Options::CAMERA_CENTER_X, Options::CAMERA_CENTER_Y + Utils::coord(200)));
    text3->setPosition(ccp(Options::CAMERA_CENTER_X, Options::CAMERA_CENTER_Y + Utils::coord(100)));
...
void Progress::onTouchButtonsCallback(const int pAction, const int pID)
{
    ...
    if(pSender->mResetPopup->mShowed) return;
