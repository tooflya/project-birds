...
cc.Leaderboard = cc.Popup.extend({
    init:function(p_Parent) {
        ...
        this.m_RateText1 = cc.Text.createWithText(cc.Languages.text_temp_leaderboard_1, this);
        this.m_RateText2 = cc.Text.createWithText(cc.Languages.text_temp_leaderboard_2, this);
...
cc.Leaderboard.create = function(p_Parent) {
    var popup = new cc.Leaderboard();
    popup.init(p_Parent);
