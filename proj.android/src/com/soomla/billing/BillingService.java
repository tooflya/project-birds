...
public class BillingService extends Service implements ServiceConnection {
    private static final String TAG = "SOOMLA BillingService1";
    ...
    public class RequestPurchase extends BillingRequest {
        ...
        protected long run() throws RemoteException {
            ...
            StoreUtils.LogDebug(TAG, "1"); //
            if (pendingIntent == null) {
                StoreUtils.LogError(TAG, "Error with requestPurchase");
                return Consts.BILLING_RESPONSE_INVALID_REQUEST_ID;
            }
            StoreUtils.LogDebug(TAG, "2"); //

            Intent intent = new Intent();
            StoreUtils.LogDebug(TAG, "4"); //
            ResponseHandler.buyPageIntentResponse(pendingIntent, intent);
            StoreUtils.LogDebug(TAG, "3"); //
